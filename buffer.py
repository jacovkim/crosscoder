...
class Buffer:
    ...
    def refresh(self):
        ...
        with torch.autocast("cuda", torch.bfloat16):
            ...
            for _ in tqdm.trange(0, num_batches, self.cfg["model_batch_size"]):
                ...
                self.buffer[self.pointer : self.pointer + acts.shape[0]] = acts.detach()
    ...
    def next(self):
        out = self.buffer[self.pointer : self.pointer + self.cfg["batch_size"]].clone().detach().requires_grad_(True)
